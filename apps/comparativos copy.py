...
def update_charts(regiao, ano, referencia, escopo):
    ...
    if referencia == 'area_conhecimento':
        ...
        grafico_nota_redacao = geraGrafico(tipoGrafico, filtered_data, "med_idade", "med_nota_redacao", cor, None, 'num_participantes', 'Media Redação',hover)
        ...
        grafico_nota_redacao = geraGrafico(tipoGrafico, filtered_data, eixo_x, "med_nota_redacao", hover, grupo, 'num_participantes', 'Media Redação', hover)
